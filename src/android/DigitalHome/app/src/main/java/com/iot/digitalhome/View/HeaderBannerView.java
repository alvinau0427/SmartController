...
import com.iot.digitalhome.Adapter.HeaderBannerAdapter;
...
public class HeaderBannerView extends HeaderViewInterface<List<String>> {
    ...
    private static final int BANNER_TIME = 7000; // ms
    ...
    public HeaderBannerView(Activity context) {
        ...
        bannerHeight = DensityUtil.getWindowWidth(context) * 7 / 16;
    }
    ...
    private void dealWithTheView(List<String> list) {
        ...
        controlViewPagerSpeed(vpBanner, 1000);
    }
    ...
    private void addIndicatorImageViews() {
        ...
        for (int i = 0; i < bannerCount; i++) {
            ...
            iv.setBackgroundResource(R.xml.xml_round_orange_grey_sel);
            iv.setEnabled(false);
            if (i == 0) {
                iv.setEnabled(true);
            }
